...
sudo mv /home/pi/tgn_setup_lib/setup_files/tw_auth.py /usr/local/lib/python3.5/dist-packages/
...
sudo rm -fr /home/pi/tgn_smart_home/update_4.py
...
read answer
if [ "$answer" != "${answer#[Yy]}" ] ;then
sudo pip3 install numpy scipy matplotlib ipython pandas sympy nose
...
echo -e "\e[33m>> \e[31mInstall Retropie (y/n)?\e[32m"
read answer
if [ "$answer" != "${answer#[Yy]}" ] ;then
...
echo -e "\e[33m>> \e[31mSatrt with 'emulationstation'\e[32m"
clear
fi
