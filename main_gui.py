...
B7 = Button(buttonFrame1, text="All On", bg=buttonb, width=15, command=all_on)
B7.grid(row=3, column=0, padx=10, pady=3)
B8 = Button(buttonFrame1, text="All Off", bg=buttonb, width=15, command=all_off)
...
B2.grid(row=1, column=1, padx=10, pady=3)
B3 = Button(buttonFrame2, text="Scan NFC", bg=buttona, width=15, command=callback30)
B3.grid(row=1, column=2, padx=10, pady=3)
