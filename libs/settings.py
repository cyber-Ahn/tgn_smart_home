...
def waether_settings():
	region = input("Region Code - 6947479: ")
	wkey = input("Open Weather Api Key - 3aef357118b7ea5d700123785674b45: ")
	print("write eeprom, please wait.....")
	start_add_S = 0xa7
	index = 0 
	while index < 7:
...
def pushbullet_settings():
	pkey = input("Pushbullet Api Key - o.luRM2iMEGKnns3pzkOUiEAGX3IxxVxZ :")
	print("write eeprom, please wait.....")
	start_add_U = 0xcf
	index = 0 
	while index < 34:
...
def thinkspeak_settings():
	chanl= input("ThinkSpeak channle ID - 43245 :")
	wkey = input("ThinkSpeak writekey - 8WQB01T3F5JEEZY :")
	rkey = input("thinkspeak readkey - PJGJDHMEUU1AXQ1 :")
	print("write eeprom, please wait.....")
	start_add_V = 0x01
	index = 0 
	while index < 6:
...
def save_nfc():
	...
	name = encode(input("Name - cyber-Ahn: "))
	function = encode(input("function - all_on-all_off-login-exit: "))
