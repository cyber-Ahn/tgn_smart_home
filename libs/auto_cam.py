...
def ini():
	...
	sleep_t = ""
	while index < 3:
		cach = read_eeprom(1,0x54,0x00,start_add_K)
		if cach != "X":
	...
	start = ""
	while index < 5:
		cach = read_eeprom(1,0x54,0x00,start_add_L)
		if cach != "X":
			start = start + cach
		index = index + 1
	...
	while index < 5:
		cach = read_eeprom(1,0x54,0x00,start_add_M)
		if cach != "X":
			end = end + cach
		index = index + 1
	...
	sound = ""
	while index < 3:
		cach = read_eeprom(1,0x54,0x00,start_add_N)
		if cach != "X":
			sound = sound + cach
		index = index + 1
